...
Raised equatorial Atlantic SSTs lessen the land-ocean thermal contrast, resulting in weaker penetration of the Monsoon flow into the continent and reduced moisture convergence over the Sahel \parencite{vizy2002development, giannini2003oceanic, losada2010multi}, although an increased northerly supply of moisture evaporated from a warming Mediterranean provides a counteractive effect \parencite{rowell2003impact, gaetani2010influence}.
This weakening of the low-level surface monsoon circulation has also been used to explain the impact of differential (south-favouring) hemispheric warming, particurly in the Atlantic, via a reduction in the cross-equatorial atmopsheric pressure gradient \parencite{lu2005oceanic, chung2007relationship, biasutti2006robust, zhang2006impact}.
% Although an alternative proposed mechanism includes ... --> energetic reogranisation of Hadley Cell circulation -->  Equatorword ITCZ 
% Pertubations are enhanced by land surface feedbacks \parencite{giannini2003oceanic}
% Warmer tropical Atlantic SSTs --> Northward ITCZ shift. (ward1998diagnosis)
% Some moisture is zonal, some meridional \parencite{fontaine2003atmospheric, } 
...
% Several GCM studies do describe changes to TEJ/AEJ, but interpretation of their effect is largely ignored in favour of traditional, e.g. rowell2001telleconnections, lu2005oceanic
