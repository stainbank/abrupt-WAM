...
While recent modelling studies do assert the importance of jet dynamics in Sahel rainfall hindcasts \parencite{philippon2010skill, xue2010intercomparison, ruti2011west, diallo2013interannual}, the identification of relevant mechanisms of oceanic influence remains frustrated because GCM spatiotemporal resolutions are generally insufficient to realistically represent the appropriate atmospheric features \parencite{caminade2010twentieth, druyan2011studies, tseng2016diagnosing, vellinga2016sahel, whittleston2017climate}.
Various proposals have nevertheless been made.
For example, warm ENSO phases may provoke weakening of the TEJ and the westerly jets, and an equatorword movement of the AEJ, by the establishment of anomalous equatoreal zonal circulation \parencite{joly2009influence, okonkwo2015combined, villamayor2015robust, preethi2015impacts}.
Relative cooling of the North Atlantic may ...
Futhermore, \citeauthor{liu2014atmospheric}\parencite{liu2014atmospheric} describe a self-reinforcing southward shift of the AEJ as an energetic response to an initial, ocean forced, aridification. 
