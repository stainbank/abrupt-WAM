...
For example, several General Circulation Model (GCM) experiments have succesfully reproduced much of the sensitivity of monsoon rainfall to sea surface temperatures --- in various ocean basins --- apparent in the observational record \parencite[e.g.][]{rowell1995variability, giannini2003oceanic, lu2005oceanic}, while others demonstrate the importance of land-surface--atmosphere interactions in amplifying these oceanic forcings \parencite{giannini2005dynamics, kucharski2013further}.
However, many of these studies contradict each other in terms of mechanism, no clear dominant mechanism has emerged, no agreement on future \parencite{druyan2011studies}.
Partially because future changes are huge compared to decadal variability.
