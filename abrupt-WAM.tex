...
Nevetheless, the timing of these transitions is corroborated by palaeolake carbonate records --- which assume that the input--evaporation balance controls the oxygen isotopic signal (\delO) --- including a brief positive \delO{} excursion signalling the interruption of high water levels by YD aridity \parencite{gasse1990arid}.
