...
The traditional description of the WAM \parencite[e.g.][]{sultan2000abrupt, sultan2003west2, ramel2006northward} posits that the Monsoon flow --- a low level southwesterly flow of marine moisture driven over the African continent by the thermal pressure gradient established, during the boreal summer, between the Atlantic Ocean and the Saharan Heat Low (SHL) \parencite{hall2006dynamics, grams2010atlantic} --- is precipitated by deep convection at the Intertropical Convergence Zone (ITCZ).
% and the ITCZ is?
Accordingly, variability in the monsoon rain band is determined by the strength and latitudinal position of the ITCZ, and the two features are effectively treated synonymously \parencite{janicot1998west, damato1998characteristics, sultan2003west2, ramel2006northward}. 
...
In this emerging paradigm, the tropical rainbelt is produced by a column of ascending air that is largely independent of the ITCZ \parencite{grist2001study}.
