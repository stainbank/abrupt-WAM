...
The traditional description of the WAM \parencite[see][]{sultan2000abrupt, sultan2003west2, ramel2006northward} posits that the Monsoon flow --- a low level southwesterly flow of marine moisture over the African continent driven by the pressure gradient between the Saharan Heat Low (SHL), an intense thermal low that develops during the boreal summer over the hot desert, and the cooler Atlantic Ocean \parencite{hall2006dynamics, grams2010atlantic} --- is precipitated by deep convection at the Intertropical Convergence Zone (ITCZ). 
This model holds that rainfall variability is modulated by the strength and latitudinal position of, and moisture availability at, the ITCZ \parencite{folland1986sahel, janicot1998west, damato1998characteristics, sultan2003west1}, with which the monsoon rainband is often treated synonymously \parencite[e.g.][]{ramel2006northward, braconnot2007results}.
