...
In this \emph{revised} model, the monsoon rainbelt is largely independent of the surface circulation described above \parencite{grist2001study}, with WAM dynamics characterised instead by the interaction of three zonal jets higher up in the troposphere.  
...
% the mid-level African Easterly Jet (AEJ), which modulates position...;
% and finally the high level Tropical Easterly Jet (TEJ), whose. 
% The monsoon rainbelt is generated a deep column of ascending air bound by the axes of the mid-level African Easterly Jet (AEJ) the high level Tropical Easterly Jet (TEJ). 
