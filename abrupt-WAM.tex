...
The long-term pacing of North African climatology by Milankovitch forcing, and the associated Quaternary glaciations, can be discerned through the use of marine core sediment's magnetic properties \parencite{bloemendal1989evidence, larrasoana2003three} and non-carbonate fraction \parencite{tiedemann1989climatic, tiedemann1994astronomic} as proxies for the Saharan dust flux.
These show that the most recent deglaciation was particularly dramatic, with hyperaridity during the Last Glacial Maximum giving way to a mid-Holocene dust minimum known as the African Humid Period (AHP) \parencite{rea1994paleoclimatic, demenocal2000abrupt, adkins2006african}.
This is in agreement with continental evidence that the mid-Holocene Sahara supported extensive, highly productive wetland ecosystems, including the geomorphological imprints of immense North African lakes apparent in satellite radar imagery \parencite{schuster2005holocene, drake2006shorelines} and palaeohydroecological reconstructions from thick layers of lacustrine sediment laden with fossil pollen \parencite{ritchie1985sediment, lezine1990across, jolly1998biome}. 

% However, in contast to the relatively gradual orbital forcing, multiple sharp discontuities in the high resolution palaeosedimentation records indicate exceptionally abrupt climatalogical transitions at, at and at. 
% for all but the termination, there is association with glacial reorganisations
...
% 
% However, despite the gradualness of the orbital forcing, sharp discontinuities in very high resolution Atlantic palaeosedimentation records indicate that the most recent arid--humid transitions --- at the end of the LGM, into and out of the YD, and at the end of AHP --- were exceptionally abrupt \parencite{demenocal2000abrupt, adkins2006african}.
