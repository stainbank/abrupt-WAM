...
This \emph{revised} framework defines the tropical rainbelt as a column of deep convection maintained between the axes of the African Easterly Jet (AEJ), a mid-level geostrophic wind, and the high-level Tropical Easterly Jet (TEJ).
The latitude of the rainbelt is bound to that of the AEJ to the north, while its uplift strength is modulated by the speed of the TEJ at it's southern edge \parencite{gu2004seasonal, nicholson2009revised, nicholson2013west}.
...
While recent modelling studies do assert the importance of jet dynamics in Sahel rainfall hindcasts \parencite{philippon2010skill, xue2010intercomparison, ruti2011west, diallo2013interannual}, the identification of relevant mechanisms of oceanic influence remains frustrated by insufficient GCM spatiotemporal resolutions for the realistic represention of the appropriate atmospheric features \parencite{caminade2010twentieth, druyan2011studies, tseng2016diagnosing, vellinga2016sahel, whittleston2017climate}.
