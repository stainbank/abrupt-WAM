...
The mid-level African Easterly Jet (AEJ) is a mid-level geostrophic feature whose position are sensitive to the surface meridional thermal gradient over West Africa \parencite{cook1999generation}. 
The high-level Tropical Easterly Jet (TEJ) ... 
% Describe TEJ, integrate these descriptions into introduction to new framework 
