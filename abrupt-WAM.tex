...
However, recent years have seen the emergence of a new paradigm in WAM \parencite[see][for a comprehensive overview]{nicholson2009revised}.
In this \emph{revised} model, the monsoon rainbelt is largely independent of the surface circulation described above \parencite{grist2001study}, with WAM dynamics characterised instead by a deep column of ascending moist air originating from the interaction of zonal winds higher in the troposphere.
The latitudinal position of the rainbelt tracks that of the mid-level African Easterly Jet (AEJ) bounding it to the north, while the strength of ascent, and therefore rainfall, is strongly modulated by the intensity of the high-level Tropical Easterly Jet (TEJ) at it's southern edge \parencite{nicholson2009revised, nicholson2013west}.
With regards to moisture, a highly variable supply to the Sahel is provided from the eastern Atlantic moisture by a pair of low-level westerly jets, regional-scale circulation features which have recently been identified as distinct from, and dominant over, the classic Monsoon flow \parencite{grodsky2003near, pu2010dynamics, nicholson2013west}.

The influence of oceans on Sahellian climate can therefore be interpreted through their effect on atmospheric jet dynamics. 
% The modulation of westerly flows by 
...
Several older GCM studies describe changes in atmospheric jet dynamics but neglect to consider their influence on Sahellian climate in favour of the classical interpretation \parencite[e.g.][]{rowell2001teleconnections, lu2005oceanic, zhang2006impact}. % whereas more recent analyses tend to consider both interpretations.
Newer studies, such as those 
For example, 
