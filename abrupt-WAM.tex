...
The postglacial climatalogical transition was not smooth: high resolution Atlantic palaeosedimentation records indicate a rapid onset of the AHP following Heinrich Event 1 (H1), an abrupt spike in the Saharan dust flux during the Younger Dryas stadial (YD), and a century-scale return to modern arid conditions \parencite{demenocal2000abrupt, adkins2006african}.
The assumption of terrigenous marine sedimentation as a linear proxy of Saharan land conditions belies the spatial heteregeneity in dust emission \parencite{}, and wind \ldots 
The use of terrigenous marine sedimentation as a proxy for desert area, an assumption is made that the entire Sahara behaves as a homogenous dust source,  \ldots
Nevetheless, the timing of these transitions is corroborated by palaeolake carbonate records showing --- on the assumption that the input--evaporation balance controls the oxygen isotopic signal (\delO) --- a brief positive \delO{} excursion signalling the interruption of high water levels by YD aridity \parencite{gasse1990arid}. 
